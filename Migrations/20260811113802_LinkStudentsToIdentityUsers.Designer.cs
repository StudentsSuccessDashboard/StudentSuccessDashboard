...
namespace StudentSuccessDashboard.Migrations
{
    ...
    [Migration("20260811113802_LinkStudentsToIdentityUsers")]
    partial class LinkStudentsToIdentityUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentSuccessDashboard.Models.Exam", b =>
                {
            ...
            modelBuilder.Entity("StudentSuccessDashboard.Models.Quiz", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudentSuccessDashboard.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentSuccessDashboard.Models.Course", b =>
                {
                    b.HasOne("StudentSuccessDashboard.Models.Semester", "Semester")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("StudentSuccessDashboard.Models.Student", b =>
                {
                    b.HasOne("StudentSuccessDashboard.Data.ApplicationUser", "User")
                        .WithOne("Student")
                        .HasForeignKey("StudentSuccessDashboard.Models.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
